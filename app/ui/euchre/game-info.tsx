...
export function GameInfo({ playerInfoState }: Props) {
  ...
  return (
    <div className="grid grid-flow-col grid-rows-3 gap-1 h-full w-full text-black grid-cols-[1fr,175px,1fr]">
      ...
      <div
        id="player3-region"
        className="bg-white col-span-1 col-start-1 row-start-2 relative bg-opacity-50 flex justify-center items-center"
      >
      ...
      <div
        id="player4-region"
        className="bg-white col-span-1 col-start-3 row-start-2 relative bg-opacity-50 flex justify-center items-center"
      >
      ...
      <div
        id="player1-region"
        className="bg-white col-span-1 col-start-2 row-start-3 relative bg-opacity-50 flex justify-center items-center"
      >
