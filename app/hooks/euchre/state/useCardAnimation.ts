...
// import useCardStateEffect from '../effects/play/useCardStateEffect';
...
//     const initialValues = getSpringsPlayerHandInitDeal(player.hand, handState.location);
//     const initStates = createStates(
//       player.hand,
//       handState.location,
//       !!handState.shouldShowCardValue,
//       initialValues.cardSprings,
//       initialValues.flipSprings,
//       false
//     );
...
//       } else {
//         logConsole('[CARD STATE] - NO EFFECT TO RUN');
//       }
//     };
