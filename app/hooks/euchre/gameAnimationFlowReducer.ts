...
const actionTypeMap: Map<EuchreActionType, EuchreAnimateType> = new Map([
  ...
  [
    EuchreActionType.SET_ANIMATE_RETURN_CARDS_TO_DEALER,
    EuchreAnimateType.ANIMATE_RETURN_CARDS_TO_DEALER
  ],
  [
    EuchreActionType.SET_ANIMATE_PASS_CARDS_TO_PLAYERS,
  ...
  [
    EuchreActionType.SET_ANIMATE_BEGIN_PLAY_CARD_RESULT,
