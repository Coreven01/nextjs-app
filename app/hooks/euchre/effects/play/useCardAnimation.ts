...
import { availableCardsToPlay } from '../../../../../features/euchre/util/game/playerDataUtil';
import { sortCardsIndices } from '../../../../../features/euchre/util/game/cardDataUtil';
import { getCalculatedWidthOffset } from '../../../../../features/euchre/util/play/cardTransformUtil';
...
import useCardInitAnimation from '../../../../../features/euchre/hooks/play/useCardInitAnimation';
import useCardPlayAnimation from '../../../../../features/euchre/hooks/play/useCardPlayAnimation';
...
const useCardAnimation = (
  ...
  //     dispatchAnimationState.setCardAnimationControls(newAnimationControls);
  //   },
  ...
  // /** Animate cards to move cards off screen for a player sitting out for the current hand. */
  // const animatePlayerSittingOut = useCallback(async () => {
  ...
  //     moveOffScreen.transition = { delay: duration, duration };
  ...
  //   logConsole('[ANIMATE DISCARD] | ', euchreGame.discard, euchreGame.trump, player.hand);
  //   logConsole('[CARD STATE] [animateTrickFinished]', ' player: ', player.name);
  ...
  // //#region Regular Play Card Animation Handlers
  ...
  // }, [cardRefs, onTrumpOrderedComplete, player.playerNumber]);
  ...
  // }, [animatePassDeal, euchreSettings, onDealPassed, player.playerNumber]);

  // /** */
  // const handleSittingOut = useCallback(async () => {
  //   await animatePlayerSittingOut();
  // }, [animatePlayerSittingOut]);
