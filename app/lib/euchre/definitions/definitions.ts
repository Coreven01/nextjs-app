...
export const MINIMUM_NOTIFICATION_SPEED = 800;
export const AVAILABLE_GAME_SPEED: GameSpeed[] = [350, 500, 800, 1200, 2000, 3000, 4000, 5000];
...
export type GameSpeed = 350 | 500 | 800 | 1200 | 2000 | 3000 | 4000 | 5000;
export type Suit = '♠' | '♥' | '♦' | '♣';
