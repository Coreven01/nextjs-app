...
import { cardIsLeftBower } from '../../util/game/cardDataUtil';
import { getCardClassColorFromSuit, getCardFullName } from '../../util/game/cardSvgDataUtil';
import { EuchreHandResult, ResultHighlight } from '../../definitions/definitions';
import { EuchreTrick, EuchrePlayer, EuchreCard } from '../../definitions/game-state-definitions';
