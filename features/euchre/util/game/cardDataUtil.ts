...
/** */
const getCardValueBySuit = (card: Card, trumpCard: Card | null) => {
  let retval = 0;
...
/** */
const getCardValue = (card: Card, trump: Card | null): number => {
 ...
 *
 */
const createPlaceholderCards = (deckSize: number): Card[] => {
  const retval: Card[] = [];
